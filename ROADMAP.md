...
23. 🚧 Purchase Posting
   - Steps 1–12 completed: Purchase posting semantics now consume authoritative Phase 21 Inventory Valuation for all stock invoice/return/correction amounts.
...
Phase 23 — Purchase Posting & Accounting Integration is now the current implementation target. Steps 1–12 are complete on `phase/23-purchase-posting`, based on `main@7f1b615e8e406befa0cf3967134e99d76b456a27`. Phase 22 semantic Tag/GitHub Release publication remains a separate repository-owner action.
