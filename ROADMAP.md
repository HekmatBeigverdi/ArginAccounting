...
23. 🚧 Purchase Posting
   ...
   - Steps 1–26 completed: Purchase workspace exposes Posting status/trace and the fulfillment-accounting policy now gates stock Supplier Invoices on complete receipt while allowing service/non-stock lines without Inventory receipt.
...
Phase 23 — Purchase Posting & Accounting Integration is now the current implementation target. CR-23-01 expands the phase to 36 steps; Steps 1–26 are complete on `phase/23-purchase-posting`, based on `main@7f1b615e8e406befa0cf3967134e99d76b456a27`. Step 27 is the next target. Phase 22 semantic Tag/GitHub Release publication remains a separate repository-owner action.
