...
23. 🚧 Purchase Posting
   - Steps 1–14 completed: canonical Accounting Draft Journals and Purchase Posting linkage now commit through one atomic Unit-of-Work boundary.
...
Phase 23 — Purchase Posting & Accounting Integration is now the current implementation target. Steps 1–14 are complete on `phase/23-purchase-posting`, based on `main@7f1b615e8e406befa0cf3967134e99d76b456a27`. Phase 22 semantic Tag/GitHub Release publication remains a separate repository-owner action.
