export const WAREHOUSE_DOMAIN_ERROR_CODES = {
  ...
  branchIdRequired: "warehouse.branch-id.required",
  branchReferenceRequired: "warehouse.branch-reference.required",
  branchReferenceMismatch: "warehouse.branch-reference.mismatch",
  branchCompanyMismatch: "warehouse.branch-company.mismatch",
  branchInactive: "warehouse.branch.inactive",
  archivedOrganizationChangeForbidden: "warehouse.archived-organization-change.forbidden",
  zoneIdRequired: "warehouse.zone-id.required",
  locationIdRequired: "warehouse.location-id.required",
  warehouseReferenceRequired: "warehouse.reference.required",
  physicalCompanyMismatch: "warehouse.physical.company-mismatch",
  physicalWarehouseMismatch: "warehouse.physical.warehouse-mismatch",
  zoneReferenceRequired: "warehouse.zone-reference.required",
  zoneReferenceMismatch: "warehouse.zone-reference.mismatch",
  parentLocationSelfReference: "warehouse.location.parent-self-reference",
  parentLocationCycle: "warehouse.location.parent-cycle",
  locationMoveInvalid: "warehouse.location.move-invalid",
  locationKindInvalid: "warehouse.location-kind.invalid",
  physicalStatusInvalid: "warehouse.physical-status.invalid",
  physicalTimestampRegression: "warehouse.physical.timestamp-regression",
  externalIdentifierNamespaceRequired: "warehouse.external-identifier.namespace-required",
  externalIdentifierValueRequired: "warehouse.external-identifier.value-required",
  duplicateCode: "warehouse.duplicate.code",
  duplicateExternalIdentifier: "warehouse.duplicate.external-identifier",
  duplicateWarehouseId: "warehouse.duplicate.id",
