...
export interface SubmitJournalVoucherLifecycleCommand {
...
export interface DecideJournalVoucherLifecycleApprovalCommand {
  readonly context: JournalVoucherLifecycleCommandContext;
  readonly voucherId: string;
  readonly expectedVersion: number;
...
export interface PostJournalVoucherLifecycleCommand {
  readonly context: JournalVoucherLifecycleCommandContext;
  readonly voucherId: string;
  readonly expectedVersion: number;
...
export interface ReopenJournalVoucherLifecycleCommand {
  readonly context: JournalVoucherLifecycleCommandContext;
  readonly voucherId: string;
  readonly expectedVersion: number;
  readonly actor: ApprovalActor;
...
export interface ReverseJournalVoucherLifecycleCommand {
  readonly context: JournalVoucherLifecycleCommandContext;
  readonly voucherId: string;
  readonly expectedVersion: number;
...
export interface GetJournalVoucherLifecycleQuery {
  readonly companyId: string;
  readonly voucherId: string;
}

export type JournalVoucherLifecycleActionCapability =
  | "edit"
  | "delete"
  | "submit_for_approval"
  | "approve"
...
export interface JournalVoucherLifecycleCapabilitiesDto {
  readonly editable: boolean;
  readonly deletable: boolean;
  readonly actions: readonly JournalVoucherLifecycleActionCapability[];
}

export interface JournalVoucherApprovalTraceDto {
  readonly approvalRequestId: string;
  readonly submittedContentVersion: number;
  readonly status: "pending" | "approved" | "closed";
  readonly isCurrent: boolean;
}

export interface JournalVoucherPostingTraceDto {
  readonly approvalRequestId: string;
  readonly submittedContentVersion: number;
...
export interface JournalVoucherAmendmentTraceDto {
  readonly approvalRequestId: string;
...
export interface JournalVoucherReversalTraceDto {
...
export interface JournalVoucherLifecycleDto {
  readonly voucherId: string;
  readonly companyId: string;
  readonly status: JournalVoucherStatus;
  readonly version: number;
  readonly capabilities: JournalVoucherLifecycleCapabilitiesDto;
  readonly approval: JournalVoucherApprovalTraceDto | null;
  readonly posting: JournalVoucherPostingTraceDto | null;
  readonly latestAmendment: JournalVoucherAmendmentTraceDto | null;
  readonly reversal: JournalVoucherReversalTraceDto | null;
}
...
export class JournalVoucherLifecycleApplicationError extends Error {
  constructor(
    readonly code: JournalVoucherLifecycleApplicationErrorCode,
    message: string,
