...
const sharedAccounts: readonly AccountDefinition[] = [
  ...
  account(
    ...
    { currencyEnabled: true, revaluationEnabled: true },
  ),
  account(
    ...
    { trackingEnabled: true, dueDateEnabled: true },
  ),
  account(
  ...
  account(
    "assets.non-current.accumulated-depreciation",
    "assets.non-current",
    "subsidiary",
    "1202",
    "استهلاک انباشته",
  ...
  account(
    ...
    false,
    620,
    { incomeStatementSection: "finance_costs" },
  ),
  account(
    "expenses.finance.bank",
    "expenses.finance",
    "subsidiary",
    "6201",
    "هزینه‌های بانکی و تأمین مالی",
...
const serviceAccounts: readonly AccountDefinition[] = [
  ...
  account(
    ...
    false,
    500,
    { incomeStatementSection: "cost_of_sales" },
  ),
  account(
    "costs.service",
    "costs",
  ...
  account(
    ...
    511,
    {
      incomeStatementSection: "cost_of_sales",
      cashFlowCategory: "operating",
      managementTags: ["بهای خدمات"],
    },
  ),
  account(
    "costs.service.subcontract",
    "costs.service",
    "subsidiary",
    "5102",
    "خدمات پیمانکاران",
...
const tradingAccounts: readonly AccountDefinition[] = [
  ...
  account(
    ...
    511,
    {
      incomeStatementSection: "cost_of_sales",
      cashFlowCategory: "operating",
      managementTags: ["بهای کالای فروش‌رفته"],
    },
  ),
  account(
    "purchases",
  ...
  account(
    "purchases.merchandise.domestic",
    "purchases.merchandise",
    "subsidiary",
    "7101",
    "خرید داخلی کالا",
    "Domestic merchandise purchases",
    "strict_debit",
    "income_statement",
    true,
    711,
...
const manufacturingAccounts: readonly AccountDefinition[] = [
  account(
    ...
    114,
    {
      balanceSheetSection: "assets",
      cashFlowCategory: "operating",
      managementTags: ["مواد اولیه"],
    },
  ),
  account(
    "assets.current.work-in-progress",
    "assets.current",
    "subsidiary",
    "1105",
    "کالای در جریان ساخت",
    ...
    115,
    {
      balanceSheetSection: "assets",
      cashFlowCategory: "operating",
      managementTags: ["در جریان ساخت"],
    },
  ),
  account(
    "assets.current.finished-goods",
    "assets.current",
    "subsidiary",
    "1106",
    "کالای ساخته‌شده",
    ...
    116,
    {
      balanceSheetSection: "assets",
      cashFlowCategory: "operating",
      managementTags: ["کالای ساخته‌شده"],
    },
  ),
  account(
    "revenue",
  ...
  account(
    ...
    511,
    {
      incomeStatementSection: "cost_of_sales",
      cashFlowCategory: "operating",
      managementTags: ["مواد مستقیم"],
    },
  ),
  account(
    "costs.manufacturing.labor",
    "costs.manufacturing",
    "subsidiary",
    "5102",
    "دستمزد مستقیم تولید",
  ...
  account(
    ...
    513,
    {
      incomeStatementSection: "cost_of_sales",
      cashFlowCategory: "operating",
      managementTags: ["سربار تولید"],
    },
  ),
  account(
    "costs.manufacturing.goods-sold",
    "costs.manufacturing",
    "subsidiary",
    "5104",
    "بهای تمام‌شده کالای فروش‌رفته",
...
function catalog(
  code: CodingTemplateCatalog["templateCode"],
  activityType: CodingTemplateCatalog["activityType"],
  persianName: string,
  englishName: string,
  specific: readonly AccountDefinition[],
  ...
  return Object.freeze({
    ...
    persianName,
    englishName,
    content: createCodingTemplateVersionContent(content),
  });
}
...
function account(
  ...
  level: CodingTemplateAccountItem["level"],
  code: string,
  persianName: string,
  englishName: string,
  nature: CodingTemplateAccountItem["nature"],
  statementType: CodingTemplateAccountItem["statementType"],
  postingAllowed: boolean,
  displayOrder: number,
  classification: Partial<CodingTemplateAccountReportClassification> = {},
  behavior: Partial<
    Pick<
      CodingTemplateAccountItem,
      "currencyEnabled" | "revaluationEnabled" | "trackingEnabled" | "dueDateEnabled"
    >
  > = {},
): AccountDefinition {
  return {
    ...
    nature,
    normalBalance:
      nature === "credit" || nature === "strict_credit" ? "credit" : "debit",
    statementType,
    postingAllowed,
    currencyEnabled: behavior.currencyEnabled ?? false,
    revaluationEnabled: behavior.revaluationEnabled ?? false,
    trackingEnabled: behavior.trackingEnabled ?? false,
    dueDateEnabled: behavior.dueDateEnabled ?? false,
    displayOrder,
    ...classification,
  };
}
...
function buildAccount(item: AccountDefinition): CodingTemplateAccountItem {
  const reportClassification: CodingTemplateAccountReportClassification = {
    balanceSheetSection: item.balanceSheetSection ?? null,
    incomeStatementSection: item.incomeStatementSection ?? null,
    cashFlowCategory: item.cashFlowCategory ?? null,
    cashEquivalent: item.cashEquivalent ?? false,
    receivable: item.receivable ?? false,
    payable: item.payable ?? false,
    managementTags: item.managementTags ?? [],
  };
...
function policies(
  accounts: readonly CodingTemplateAccountItem[],
): readonly CodingTemplateAccountDimensionPolicyItem[] {
  ...
  for (const item of accounts.filter((candidate) => candidate.postingAllowed)) {
    // All posting accounts get optional branch dimension
    result.push({
      accountLogicalKey: item.logicalKey,
      dimensionTypeLogicalKey: "dimension.branch",
      requirement: "optional",
    });

    // Receivable or payable accounts require party dimension
    ...
    if (isFinancialAccount) {
      result.push({
        accountLogicalKey: item.logicalKey,
        dimensionTypeLogicalKey: "dimension.party",
        requirement: "required",
      });
    }

    // Income statement accounts require cost center and optional project
    const isIncomeAccount = item.statementType === "income_statement";
    if (isIncomeAccount) {
      result.push({
        accountLogicalKey: item.logicalKey,
        dimensionTypeLogicalKey: "dimension.cost-center",
        requirement: "required",
      });
