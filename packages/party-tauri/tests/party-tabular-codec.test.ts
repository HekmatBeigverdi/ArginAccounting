...
const masterRows: readonly PartyMasterExportRow[] = [{
  ...
  nationalId: "", registrationNumber: "", economicNumber: "", legacyEconomicCode: "411111111111",
  taxFileNumber: "1234", roles: "customer", phone: "", mobile: "09121234567",
  email: "ali@example.com", addressLine: "تهران، خیابان نمونه", postalCode: "1234567890",
...
test("master-data CSV preserves identity and address columns", () => {
  ...
  assert.equal(parsed.rows[0]?.legacyEconomicCode, "411111111111");
