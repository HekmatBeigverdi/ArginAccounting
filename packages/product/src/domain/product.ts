...
export const PRODUCT_DOMAIN_ERROR_CODES = {
  ...
  commercialAttributeInvalid: "product.commercial-attribute.invalid",
  taxTreatmentInvalid: "product.tax-treatment.invalid",
  vatRateInvalid: "product.vat-rate.invalid",
  operationalAttributeInvalid: "product.operational-attribute.invalid",
  serviceStockTrackingInvalid: "product.service-stock-tracking.invalid",
