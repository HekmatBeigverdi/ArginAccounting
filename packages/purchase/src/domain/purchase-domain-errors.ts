export const PURCHASE_DOMAIN_ERROR_CODES = Object.freeze({
  ...
  matchingInvalid: "purchase.matching_invalid",
  matchingIneligible: "purchase.matching_ineligible",
  matchingMismatch: "purchase.matching_mismatch",
  duplicateMatch: "purchase.duplicate_match",
  overMatch: "purchase.over_match",
  inventoryReceiptInvalid: "purchase.inventory_receipt_invalid",
  inventoryReceiptIneligible: "purchase.inventory_receipt_ineligible",
  inventoryReceiptDuplicateLine: "purchase.inventory_receipt_duplicate_line",
  inventoryReceiptQuantityExceeded: "purchase.inventory_receipt_quantity_exceeded",
  inventoryValuationCostInvalid: "purchase.inventory_valuation_cost_invalid",
  inventoryValuationCostIneligible: "purchase.inventory_valuation_cost_ineligible",
  inventoryValuationCostMismatch: "purchase.inventory_valuation_cost_mismatch",
  purchaseCompensationInvalid: "purchase.compensation_invalid",
  purchaseCompensationIneligible: "purchase.compensation_ineligible",
  purchaseCompensationReferenceInvalid: "purchase.compensation_reference_invalid",
  purchaseCompensationQuantityInvalid: "purchase.compensation_quantity_invalid",
  purchaseCompensationDuplicateLine: "purchase.compensation_duplicate_line",
