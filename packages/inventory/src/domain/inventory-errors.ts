export const INVENTORY_DOMAIN_ERROR_CODES = Object.freeze({
  ...
  approvalIncomplete: "inventory.lifecycle.approval-incomplete",
  correctionOriginalInvalid: "inventory.correction.original-invalid",
  correctionSelfReference: "inventory.correction.self-reference",
