export const INVENTORY_DOMAIN_ERROR_CODES = Object.freeze({
  ...
  stockWorkflowUnsupported: "inventory.workflow.stock-type-unsupported",
  confirmationResolutionMismatch: "inventory.workflow.confirmation-resolution-mismatch",
  movementIdentityMismatch: "inventory.workflow.movement-identity-mismatch",
  transferIdentityInvalid: "inventory.transfer.identity-invalid",
  transferConservationInvalid: "inventory.transfer.conservation-invalid",
  adjustmentReasonRequired: "inventory.adjustment.reason-required",
  openingKeyInvalid: "inventory.opening.key-invalid",
  openingDuplicate: "inventory.opening.duplicate",
  ...
  lifecycleTransitionInvalid: "inventory.lifecycle.transition-invalid",
  lifecycleMetadataInvalid: "inventory.lifecycle.metadata-invalid",
  lifecycleHistoryInvalid: "inventory.lifecycle.history-invalid",
  documentImmutable: "inventory.lifecycle.document-immutable",
  documentDeleteDenied: "inventory.lifecycle.delete-denied",
  submissionIncomplete: "inventory.lifecycle.submission-incomplete",
  reversalReferenceInvalid: "inventory.lifecycle.reversal-reference-invalid",
