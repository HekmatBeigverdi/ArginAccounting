...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, print_current_webview, password_commands::hash_password, password_commands::verify_password])
        .plugin(tauri_plugin_sql::Builder::default().add_migrations(DATABASE_URL, database_migrations()).build())
