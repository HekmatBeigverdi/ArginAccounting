...
export const navigationItems: NavigationItem[] = [
  ...
  { label: "اشخاص", path: "/master-data/parties", group: "اطلاعات پایه", requiredPermission: "master-data.parties.view" },
  { label: "کالاها و خدمات", path: "/master-data/products", group: "اطلاعات پایه", requiredPermission: "master-data.products.view" },
  { label: "اسناد انبار", path: "/inventory/documents", group: "انبار و موجودی", requiredPermission: "inventory.documents.view" },
  { label: "گزارش‌های موجودی", path: "/inventory/reports", group: "انبار و موجودی", requiredPermission: "inventory.documents.view" },
  { label: "ارزش‌گذاری موجودی", path: "/inventory/valuation", group: "انبار و موجودی", requiredPermission: "inventory.valuation.view" },
  ...
  { label: "کدینگ حساب‌ها", path: "/accounting/chart-of-accounts", group: "حسابداری", requiredPermission: "accounting.chart-of-accounts.view" },
  { label: "ابعاد حسابداری", path: "/accounting/dimensions", group: "حسابداری", requiredPermission: "accounting.dimensions.view" },
  { label: "الگوهای کدینگ", path: "/accounting/coding-templates", group: "حسابداری", requiredPermission: "accounting.coding-templates.view" },
