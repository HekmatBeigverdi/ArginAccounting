...
23. [Phase 23 — Purchase Posting & Accounting Integration](phase-23-purchase-posting-plan.md) — CR-23-01 expands the phase to 36 steps; Steps 1–27 complete; Invoice-to-Goods-Receipt workflow with partial receipts implemented; next target is Step 28
