...
21. [Phase 21 — Inventory Valuation](phase-21-inventory-valuation-plan.md) — Steps 1–5 complete; fixed 20-step sequence preserved; Step 6 — Outflow Cost Calculation Engine — is next
