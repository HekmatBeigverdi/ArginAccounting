...
| Purchase Posting | `@argin/purchase-posting` | Branch and accounting dimensions implemented through Phase 23 Step 19 | 23 | [Purchase Posting Domain Model](../architecture/purchase-posting-domain-model.md) |
...
- Domain/Application: `packages/purchase-posting` owns Purchase posting semantics through Step 19, including canonical Journal generation, atomic/replay/concurrency/reversal/fiscal controls and policy-driven Accounting Dimension resolution.
...
- Testing: Step 19 adds Branch preservation plus Party/Product/Warehouse/Cost Center/Project dimension-source, required/optional/forbidden policy and missing-required coverage.
