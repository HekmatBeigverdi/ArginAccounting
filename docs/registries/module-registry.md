...
| Purchase Posting | `@argin/purchase-posting` | Supplier Invoice posting semantics implemented through Phase 23 Step 7 | 23 | [Purchase Posting Domain Model](../architecture/purchase-posting-domain-model.md) |
...
- Domain: `packages/purchase-posting` owns the aggregate/fact/source/event foundations, Step 6 role-based account resolution, and Step 7 Supplier Invoice posting semantics.
...
- Testing: Step 7 adds focused Supplier Invoice principal/payable semantics, stock-valuation deferral and VAT/charge deferral coverage.
