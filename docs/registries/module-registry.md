...
| Purchase Posting | `@argin/purchase-posting` | Fiscal scope and period locks implemented through Phase 23 Step 18 | 23 | [Purchase Posting Domain Model](../architecture/purchase-posting-domain-model.md) |
...
- Domain/Application: `packages/purchase-posting` owns Purchase posting semantics through Step 18, including canonical Journal generation, atomic/replay/concurrency/reversal controls and shared Fiscal Year/Period/Historical-Lock gating.
...
- Testing: Step 18 adds Fiscal Year/Period scope, locked/closed status, date-range and all/accounting/purchases Historical Lock coverage.
