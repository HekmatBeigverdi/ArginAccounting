...
Phase 13 persists only `draft` vouchers. Posting, approval, locking, reversal, replacement, voiding, and controlled amendment remain Phase 14 responsibilities.
...
- Phase 14 can add lifecycle transitions without redesigning the Phase 13 aggregate foundation.
...
- Posting/reversal in Phase 13: rejected because Phase 14 owns lifecycle transitions.
...
- Phase 13 remains Draft-only until Phase 14 is explicitly started.
